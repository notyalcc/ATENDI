...
export default function App() {
  ...
  const [modalConfirmAction, setModalAction] = useState<{ type: 'add' | 'edit' | 'delete_log' | 'error', id?: string, serviceLabel?: string } | null>(null);
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              {modalConfirmAction?.type === 'delete_log' || modalConfirmAction?.type === 'error' ? (
